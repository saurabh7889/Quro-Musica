      ...
      <div className="p-8 pb-32">
        ...
        >
          <motion.button
            ...
            className="w-full max-w-2xl p-6 rounded-3xl bg-gradient-to-br from-primary/20 via-primary/5 to-transparent border border-primary/20 hover:border-primary/40 transition-all shadow-xl hover:shadow-primary/10 backdrop-blur-xl group overflow-hidden relative"
          >
            ...
            <div className="flex items-center gap-5 relative z-10">
              <motion.div
                ...
                className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-emerald-600 flex items-center justify-center shadow-2xl group-hover:shadow-primary/50 transition-shadow"
              >
          ...
          <div className="grid grid-cols-3 gap-5">
            {quickAccessCards.map((playlist, index) => (
              <motion.div
                ...
                className="group relative p-4 rounded-2xl bg-card/40 hover:bg-card/60 backdrop-blur-xl border border-border hover:border-primary/30 cursor-pointer transition-all shadow-lg hover:shadow-2xl overflow-hidden"
              >
                {/* Hover glow effect */}
                ...
                <div className="relative flex items-center gap-4">
                  ...
                  <motion.div
                    ...
                    className="w-12 h-12 rounded-full bg-primary flex items-center justify-center shadow-2xl opacity-0 group-hover:opacity-100 transition-all"
                  >
          ...
          <div className="grid grid-cols-6 gap-5">
            {recentlyPlayed.slice(0, 12).map((song, index) => (
              ...
              >
                {/* Play button overlay */}
                <motion.div
                  className="absolute top-24 right-6 w-12 h-12 rounded-full bg-primary flex items-center justify-center shadow-2xl opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300 z-10"
                >
                  <Play className="w-6 h-6 text-primary-foreground fill-current ml-1" />
                </motion.div>
          ...
          <div className="grid grid-cols-5 gap-6">
            {playlists.slice(1, 6).map((playlist, index) => (
              ...
              >
                ...
                {/* Play button overlay */}
                <motion.div
                  className="absolute top-28 right-8 w-14 h-14 rounded-full bg-primary flex items-center justify-center shadow-2xl opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300 z-10"
                >
