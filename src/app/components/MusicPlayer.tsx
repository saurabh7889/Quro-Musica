    ...
    <>
      ...
      <div className="hidden md:flex h-24 bg-background/80 backdrop-blur-3xl border-t border-border px-8 items-center gap-8 relative overflow-hidden transition-all duration-300">
        ...
        <div className="flex items-center gap-5 w-1/4 relative z-10">
          ...
          >
            <Heart
              className={`w-5 h-5 transition-all ${currentSong.liked ? "fill-primary text-primary" : ""}`}
            />
          </motion.button>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center gap-3 relative z-10">
          ...
          <div className="flex items-center gap-6">
            <motion.button
              ...
              className={`transition-all ${isShuffle ? "text-primary drop-shadow-[0_0_8px_rgba(29,185,84,0.4)]" : "text-muted-foreground hover:text-foreground"}`}
            >
            ...
            <motion.button
              ...
              className={`transition-all ${repeatMode > 0 ? "text-primary drop-shadow-[0_0_8px_rgba(29,185,84,0.4)]" : "text-muted-foreground hover:text-foreground"}`}
            >
        ...
        <div className="flex items-center gap-5 w-1/4 justify-end relative z-10">
          <div className="group relative">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className={`transition-all p-2 rounded-full hover:bg-accent ${isQueueVisible ? "text-primary" : "text-muted-foreground hover:text-foreground"}`}
            >
